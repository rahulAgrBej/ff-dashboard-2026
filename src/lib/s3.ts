...
/** fixtures/reports/** stands in for the bucket when USE_FIXTURES is set, so the index can be exercised without any AWS call. */
...
const fixtureFiles = import.meta.glob('/fixtures/reports/**/*.md', {
  eager: true,
  query: '?raw',
  import: 'default',
